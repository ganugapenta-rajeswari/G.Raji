...
<style>
    ...
    [data-testid="stSidebar"] .stRadio div[aria-checked="true"] > label::before {
        content: '';
        position: absolute;
        left: 0;
        top: 10%;
    ...
    with st.sidebar:
        ...
        if 'user_id' in st.session_state:
            ...
            <div style="
                ...
                <div style="flex: 1;">
                    <p style="margin: 0; font-size: 0.9rem; font-weight: 500; color: #c9d1d9;">{st.session_state.get('username', 'User')}</p>
                    <p style="margin: 0; font-size: 0.75rem; color: #8b949e;">Pro Plan</p>
                </div>
            </div>
            """, unsafe_allow_html=True)
